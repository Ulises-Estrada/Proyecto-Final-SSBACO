...
genero = tk.Label(root, text="Genero",font=(15)).grid(row = 5, column = 0,sticky="nsew")
genero_entry = tk.Entry(root,width=30,font=(15))
genero_entry.grid(row = 5, column = 1)

telefono = tk.Label(root, text="Teléfono",font=(15)).grid(row = 6, column = 0,sticky="nsew")
telefono_entry = tk.Entry(root,width=30,font=(15))
telefono_entry.grid(row = 6, column = 1)

correo = tk.Label(root, text="Correo",font=(15)).grid(row = 7, column = 0,sticky="nsew")
correo_entry = tk.Entry(root,width=30,font=(15))
correo_entry.grid(row = 7, column = 1)

contra = tk.Label(root, text="Contraseña",font=(15)).grid(row = 8, column = 0,sticky="nsew")
contrasena_entry = tk.Entry(root, show="*",width=30,font=(15))
contrasena_entry.grid(row = 8, column = 1)

rol = tk.Label(root, text="Rol",font=(15)).grid(row = 9, column = 0,sticky="nsew")
rol_entry = tk.Entry(root,width=30,font=(15))
